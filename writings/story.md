...
The player is at the connection point. 
    - : "> The connction point's orb displays a vision: the host's vision."
    - : "> They're reading a text message: an invitation."
        - "Accept"
            - "You remind the host of the past: hours lost to fun and laughter."
            - "> They accept the invitation."
        - "Deny"
            - "You remind the host of the past: how little it matters now, how they don't remember you, how you don't remember them."
            - "> They don't reply to the invitation."
            - "> ..."
            - "> And that's ok."
